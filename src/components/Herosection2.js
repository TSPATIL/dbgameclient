        ...
        <div className="relative pt-24 lg:pt-28">
          <div className="mx-auto px-6 max-w-7xl md:px-12">
            <div className="text-center sm:mx-auto sm:w-10/12 lg:mr-auto lg:mt-0 lg:w-4/5">
              <h1 className="mt-8 text-wrap text-4xl md:text-5xl font-semibold text-white dark:text-white xl:text-5xl xl:[line-height:1.125]">
              QueryQuest<br className="hidden sm:block" /> 
              </h1>
              <p className="text-wrap mx-auto mt-8 max-w-2xl text-2xl text-white dark:text-gray-300 hidden sm:block">
                Adventure Awaits in the World of Query Quest Where Every Query Unveils a New Challenge!</p>
              <p className="text-wrap mx-auto mt-8 max-w-2xl text-lg text-gray-300 dark:text-gray-300 hidden sm:block">
                Welcome to your favourite educational game. Enjoy the game and make gain in experience.
              </p>
              <p className="text-wrap mx-auto mt-6 max-w-2xl text-gray-300 dark:text-gray-300 sm:hidden">
                Adventure Awaits in the World of Query Quest Where Every Query Unveils a New Challenge!
              </p>
              <div className="mt-8 flex items-center justify-center gap-4">
                <div className="p-1 rounded-[calc(var(--btn-border-radius)+4px)] bg-gray-950/5 border border-white dark:border-white dark:bg-white/5 hover:scale-105 hover:shadow-md transition duration-300">
                  <a
                    href="/docs/installation"
                    className="*:select-none dark:shadow-primary-500/10 *:disabled:opacity-20 disabled:*:text-gray-300 disabled:dark:*:text-gray-700 dark:*:disabled:!text-white group relative z-[1] flex h-11 items-center justify-center gap-1.5 rounded-[--btn-border-radius] border border-white bg-primary-500 px-4 text-white text-xl shadow-md shadow-primary-200 before:absolute before:inset-0 before:rounded-[calc(var(--btn-border-radius)-1px)] before:border before:border-primary-500 before:bg-gradient-to-b before:from-primary-600 hover:bg-primary-600 active:bg-primary-700 disabled:border-gray-200 disabled:bg-gray-100 disabled:text-gray-950/40 disabled:before:border-transparent disabled:before:bg-gray-100 disabled:before:from-transparent dark:border-0 dark:bg-primary-600 dark:before:border-0 dark:before:border-t dark:before:border-primary-400 dark:before:shadow-inner dark:before:shadow-white/10 dark:hover:bg-primary-700 dark:active:bg-primary-800 dark:active:before:from-primary-700 dark:disabled:border dark:disabled:border-gray-800/50 disabled:dark:bg-gray-900 dark:disabled:before:bg-gray-900 dark:disabled:before:from-gray-900 dark:disabled:before:shadow-none [&amp;>*:not(.sr-only)]:relative"
                  >
                    <svg
                    ...
                    <span className="text-nowrap text-white">Start Play</span>
                  </a>
                </div>
                <div className="p-1 rounded-[calc(var(--btn-border-radius)+4px)] bg-gray-950/5 border border-white dark:border-white dark:bg-white/5 hover:scale-105 hover:shadow-md transition duration-300">
                  <a
                    href="/docs/installation"
                    className="*:select-none dark:shadow-primary-500/10 *:disabled:opacity-20 disabled:*:text-gray-300 disabled:dark:*:text-gray-700 dark:*:disabled:!text-white group relative z-[1] flex h-11 items-center justify-center gap-1.5 rounded-[--btn-border-radius] border border-white bg-primary-500 px-4 text-xl text-white shadow-md shadow-primary-200 before:absolute before:inset-0 before:rounded-[calc(var(--btn-border-radius)-1px)] before:border before:border-primary-500 before:bg-gradient-to-b before:from-primary-600 hover:bg-primary-600 active:bg-primary-700 disabled:border-gray-200 disabled:bg-gray-100 disabled:text-gray-950/40 disabled:before:border-transparent disabled:before:bg-gray-100 disabled:before:from-transparent dark:border-0 dark:bg-primary-600 dark:before:border-0 dark:before:border-t dark:before:border-primary-400 dark:before:shadow-inner dark:before:shadow-white/10 dark:hover:bg-primary-700 dark:active:bg-primary-800 dark:active:before:from-primary-700 dark:disabled:border dark:disabled:border-gray-800/50 disabled:dark:bg-gray-900 dark:disabled:before:bg-gray-900 dark:disabled:before:from-gray-900 dark:disabled:before:shadow-none [&amp;>*:not(.sr-only)]:relative"
                  >
                    <svg
                      className="size-5 relative"
                      viewBox="0 0 20 20"
                    ...
                    <span className="text-nowrap text-white">About us</span>
                  </a>
                </div>
            ...
            <div className="-mx-6 relative mt-8 sm:mt-12 max-w-xl sm:mx-auto">
              ...
              <div className="swiper proofSlides pb-6 swiper-cube swiper-3d swiper-initialized swiper-horizontal swiper-watch-progress">
                <div
                  className="swiper-wrapper"
                  id="swiper-wrapper-ab88a71cf0f10e95d"
                  aria-live="off"
                  style={{
                    cursor: "grab",
                    transformOrigin: "50% 50% -288px",
                    transform:
                      "translate3d(0px, 0px, 0px) rotateX(0deg) rotateY(-180deg)",
                    swiperCubeTranslateZ: "0px",
                    transitionDuration: "0ms",
                    transitionDelay: "0ms",
                  }}
                >
                  {/* <div
                    className="px-6 pt-2 pb-12 swiper-slide swiper-slide-next"
                    role="group"
                    aria-label="3 / 3"
                    ...
                    <div className="bg-white shadow-xl shadow-accent-950/5 p-[--card-padding] rounded-[--card-border-radius] border-[--ui-light-border-color] dark:border-[--ui-dark-border-color] dark:bg-[--card-dark-bg] relative border-[length:var(--border-width)] [--anchor:100] [--border-radius:calc(var(--radius)*1px)] [--border-width:calc(var(--border)*1px)] [--border:1] [--glow:60] [--hue:240] [--lightness:67%] [--opacity:1] [--radius:24] [--saturation:84%] [--speed:2]">
                      <div>
                        <div className="h-12 w-fit mx-auto">
                          {/* <svg className="h-8 my-auto w-fit" xmlns:x="ns_extend;" xmlns:i="ns_ai;" graph="ns_graphs;" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 251.8 48" style={{enableBackground:"new 0 0 251.8 48"}}>
                                                    <g>
                  ...
                  {/* <div
                    className="px-6 pt-2 pb-12 swiper-slide swiper-slide-prev"
                    role="group"
                    aria-label="1 / 3"
                    ...
                    style={{
                      width: "576px",
                      transform:
                        "rotateX(0deg) rotateY(90deg) translate3d(0px, 0px, 0px)",
                      transitionDuration: "0ms",
                    }}
                  >
                  ...
                  {/* <div
                    className="px-6 pt-2 pb-12 swiper-slide hidden swiper-slide-visible swiper-slide-fully-visible swiper-slide-active"
                    role="group"
                    aria-label="2 / 3"
                    ...
                    style={{
                      width: "576px",
                      transform:
                        "rotateX(0deg) rotateY(180deg) translate3d(576px, 0px, 576px)",
                      transitionDuration: "0ms",
                    }}
                  >
                ...
                <div className="swiper-pagination -mb-3 *:!rounded-lg *:!w-14 *:!h-0.5 swiper-pagination-bullets swiper-pagination-horizontal">
